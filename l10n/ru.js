OC.L10N.register(
    ...
    "%s and %s" : "%s и %s",
    ", " : ",",
    "_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_::_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_" : ["%s и <strong class=\"tooltip\" title=\"%s\">%n ещё</strong>","%s и <strong class=\"tooltip\" title=\"%s\">%n ещё</strong>","%s и <strong class=\"tooltip\" title=\"%s\">%n ещё</strong>"],
    "_%s and %n more_::_%s and %n more_" : ["%s и %n ещё","%s и %n ещё","%s и %n ещё"],
    "Hello %s," : "Привет %s,",
