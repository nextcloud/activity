OC.L10N.register(
    ...
    "%s and %s" : "%s и %s",
    ", " : ",",
    "_%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>_::_%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>_" : ["%s и <strong class=\"tooltip\" title=\"%s\">ещё %n</strong>","%s и <strong class=\"tooltip\" title=\"%s\">ещё %n</strong>","%s и <strong class=\"tooltip\" title=\"%s\">ещё %n</strong>","%s и <strong class=\"tooltip\" title=\"%s\">ещё %n</strong>"],
