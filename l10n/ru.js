OC.L10N.register(
    ...
    "Activity feed for %1$s" : "Лента активности для %1$s",
    ...
    "RSS link copied to clipboard" : "Ссылка RSS скопирована",
    "Could not copy the RSS link, please copy manually:" : "Не удалось скопировать ссылку RSS, пожалуйста, скопируйте вручную:",
    ...
    "Choose for which activities you want to get an email or push notification." : "Выберите типы активностей, по которым хотите получать уведомления по эл. почте или push-уведомления.",
    "Choose for which activities you want to get a push notification." : "Выберите типы активностей, по которым хотите получать push-уведомления.",
