OC.L10N.register(
    ...
    "A file or folder has been <strong>shared</strong>" : "<strong>Опубликован</strong> файл или папка",
    "A new file or folder has been <strong>created</strong>" : "<strong>Создан</strong> новый файл или папка",
    "A file or folder has been <strong>changed</strong>" : "<strong>Изменён</strong> файл или папка",
    "A file or folder has been <strong>deleted</strong>" : "<strong>Удален</strong> файл или папка",
    "A file or folder has been <strong>restored</strong>" : "<strong>Восстановлен</strong> файл или папка",
