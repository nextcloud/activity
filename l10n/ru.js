OC.L10N.register(
    ...
    "A file or folder has been <strong>shared</strong>" : "Файл или папка были <strong>опубликованы</strong>",
    "A new file or folder has been <strong>created</strong>" : "<strong>Создан</strong> новый файл или папка",
    "A file or folder has been <strong>changed</strong>" : "Файл или папка были <strong>изменены</strong>",
    "A file or folder has been <strong>deleted</strong>" : "Файл или папка были <strong>удалены</strong>",
