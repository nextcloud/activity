OC.L10N.register(
    ...
    "Daily activity summary for " : "每日活動摘要：",
    "_and %n more _::_and %n more _" : ["以及其餘 %n 項"],
    "All activities" : "所有活動",
    "By others" : "由其他人",
    "By you" : "由您",
    "Activity notification for %s" : "%s 的活動通告",
    "Hello %s" : "%s您好，",
    "Hello %s," : "哈囉 %s ，",
    "There was some activity at %s" : "%s 有一些活動",
    "Mail" : "電子郵件",
    "Push" : "推送",
    "This application enables users to view actions related to their files in Nextcloud." : "此應用程式允許使用者能夠在 Nextcloud 中查看與其文件相關的操作。",
    "This application enables users to view actions related to their files in Nextcloud.\n\t\tOnce enabled, users will see a new icon “Activity” in their apps menu.\n\t\tWhen clicked, a new page appears for users to track the activity related to files – from new files, to deleted files, move, rename, updates and shared activity.\n\t\tThe user can configure their individual activity settings in their personal menu.\n\t\tThis sets the type of activity to record, as well as whether to the user sees their own activities,\n\t\twhether these are only available online, and whether they get an email digest on a regular basis.\n\t\tMore information is available in the Activity documentation." : "此應用程式讓使用者能夠在 Nextcloud 中查看與其文件相關的操作。\n\t\t啟用後，使用者將在其選單中看到一個「活動」新圖示。\n\t\t點選後，將顯示一個新頁面，以供使用者追踪與文件相關的活動─包含新增文件、已刪除文件、移動、重新命名、更新和共享活動。\n\t\t使用者可以在其個人選單中配置其各自的活動設定。\n\t\t此設定了想要記錄的活動類型，以及使用者是否可看到自己的活動，\n\t\t並是否僅為線上提供，以及是否定期收到電子郵件摘要。\n\t\t活動文件中提供了更多訊息。",
    "Activity feed" : "動態摘要",
    "Notifications" : "通告",
    ...
    "Daily" : "每日",
    "Weekly" : "每週",
    "Choose for which activities you want to get an email or push notification." : "選擇哪些活動是你要透過 E-mail 或推送所接收的通知",
    ...
    "Stream" : "串流",
    "Send activity emails" : "傳送有關活動的電郵",
    "Configure the default activity settings for new users." : "為新用戶設置預設活動設定。",
    "List your own actions in the stream" : "列出屬於您的活動。",
    "Notify about your own actions via email" : "透過郵件來通知有關於您的活動狀態",
    "Send emails:" : "傳送電郵：",
    "Choose for which activities you want to get an email notification, and which should show up in the activity app stream." : "選擇你希望接受到郵件通知或者在應用程式中顯示的活動。",
