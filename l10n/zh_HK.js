OC.L10N.register(
    ...
    "Daily activity summary for " : "每日系統事件摘要：",
    ...
    "Configure the default notification settings for new users." : "設定新使用都的預設通知組態。",
    ...
    "Daily" : "每日",
    "Weekly" : "每星期",
    "Choose for which activities you want to get an email or push notification." : "選擇哪些系統事件是你要透過 E-mail 或推送所接收的通知",
    "Choose for which activities you want to get a push notification." : "選擇你要推送哪些系統事件的通知",
    ...
    "Send emails:" : "傳送電郵：",
    "Choose for which activities you want to get an email notification, and which should show up in the activity app stream." : "選擇你希望接受到郵件通知或者在應用程式中顯示的系統事件。",
