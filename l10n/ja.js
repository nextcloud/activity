OC.L10N.register(
    ...
    "Daily activity summary for %s" : "%sの日次アクティビティの概要",
    ...
    "Configure the default notification settings for new users." : "新規ユーザーのデフォルトの通知設定を設定",
    "You need to set up your email address before you can receive notification emails." : "通知メールを受け取る前にメールアドレスを設定してください。",
    "Send notification emails:" : "通知メール送信アドレス: ",
    ...
    "Send daily activity summary in the morning" : "日次アクティビティの概要を朝に送信",
    "Settings" : "設定",
    "Enable RSS feed" : "RSSフィードを有効にする",
    "RSS feed" : "RSS フィード",
    "Personal Activity Settings" : "個人のアクティビティ設定",
