OC.L10N.register(
    ...
    "Last 30 days" : "30日以内",
    "Custom range" : "カスタム範囲",
    "{from} to {to}" : "{from}から {to}まで",
    "Since {from}" : "{from}以降",
    "Until {to}" : "{to}まで",
    "Enter at least {count} characters to search" : "検索するには、少なくとも{count}文字を入力してください",
    "Search by file name" : "ファイル名で検索",
    "Clear search" : "検索をクリア",
    "Filter by account" : "アカウントで絞り込む",
    "Anyone" : "誰でも",
    "Filter activities by date" : "日付でアクティビティを絞り込む",
    ...
    "Yesterday" : "昨日",
    "Loading activity summary" : "アクティビティの概要を読み込み中",
    "_%n activity since {date}_::_%n activities since {date}_" : ["{date}以降の%n件のアクティビティ"],
    "Colour shows how many activities happened on each day, from none to {max}." : "色は、各日に発生したアクティビティの数を、0件から{max}件まで示しています。",
    "_%n activity_::_%n activities_" : ["%n件のアクティビティ"],
    "{date} — count incomplete" : "{date}— 集計未完了",
    "_%n activity on {date}_::_%n activities on {date}_" : ["{date}の%n件のアクティビティ"],
    "{label} (count incomplete)" : "{label}（集計未完了）",
    "Week of {date}" : "{date}の週",
    "Activity over time" : "アクティビティの経時変化",
    "Activity per day. Each cell is one day; use the arrow keys to move between days and Enter to filter the stream by that day." : "1日ごとのアクティビティ。各セルは1日分です。矢印キーで日付間を移動し、Enterキーを押すと、その日のデータのみを表示できます。",
    "Less" : "以下",
    "More" : "さらに表示",
    "_Downloaded %n time (%s in the last 30 days)_::_Downloaded %n times (%s in the last 30 days)_" : ["ダウンロード回数 %n回（過去30日間で%s回）"],
    "_Downloaded %n time_::_Downloaded %n times_" : ["ダウンロード回数 %n回"],
    ...
    "No matching activities" : "該当するアクティビティはありません",
    "No activity matches the current filters" : "現在のフィルタ条件に一致するアクティビティはありません",
    "No activity yet" : "まだアクティビティはありません",
    "New activities" : "新しいアクティビティ",
    ...
    "Show these activities" : "これらのアクティビティを表示する",
    "Show {date}" : "{date}を表示",
    "Show {from} to {to}" : "{from}から{to}までを表示",
    "Pick a day to see what happened, or hold Shift and pick a second day for a period." : "特定の日に何が起きたかを確認するには、その日を選択してください。または、Shift キーを押しながら別の日を選択して、期間を指定することもできます。",
    "Clear selection" : "選択をクリア",
    "Unable to load the activity list" : "アクティビティリストを読み込めませんでした",
    "Loading older activities…" : "過去のアクティビティを読み込んでいます…",
    "Load older activities" : "過去のアクティビティを読み込む",
