OC.L10N.register(
    ...
    "%s and %s" : "%s と %s",
    ", " : ", ",
    "%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>::%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>" : ["%s と <strong class=\"tooltip\" title=\"%s\">それ以外に %n 個</strong>"],
    "%s and %n more::%s and %n more" : ["%s と それ以外に %n 個"],
    "Hello %s," : "%s さんこんにちは、",
    ...
    "Notify about your own actions via email" : "メールで自身のアクションを通知する",
