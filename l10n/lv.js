OC.L10N.register(
    ...
    "Your feed URL is invalid" : "Plūsmas URL ir nederīgs.",
    ...
    "Settings have been updated." : "Iestatījumi tika atjaunināti.",
    "Recent activity" : "Jaunākās darbības",
    "No activities" : "Nav darbību",
    "More activities" : "Vairāk darbību",
    "_and %n more…_::_and %n more…_" : ["un vēl %n...","un vēl %n...","un vēl %n..."],
    "All activities" : "Visas darbības",
    "By others" : "Citu",
    "By you" : "Tu",
    "Activity at %s" : "Darbības %s",
    "Hello %s" : "Sveiciens, %s!",
    "Hello %s," : "Sveiciens, %s!",
    "There was some activity at %s" : "%s bija kādas darbības",
    "_and %n more _::_and %n more _" : ["un vēl %n","un vēl %n","un vēl %n"],
    "Mail" : "E-pasts",
    "Activity" : "Darbības",
    ...
    "No matching activities" : "Nav atbilstošu darbību",
    "No activity yet" : "Vēl nav darbības",
    "New activities" : "Jaunas darbības",
    ...
    "Could not copy the RSS link, please copy manually:" : "Nevarēja ievietot starpliktuvē RSS saiti, lūgums to darīt pašrocīgi:",
    ...
    "Show these activities" : "Rādīt šīs darbības",
    "Unable to load the activity list" : "Nevarēja ielādēt darbību sarakstu",
    "Loading older activities…" : "Ielādē vecākas darbības…",
    "Load older activities" : "Ielādēt vecākas darbības",
    "Choose for which activities you want to get an email or push notification." : "Izvēlies, par kurām darbībām vēlies saņemt e-pasta vai pašpiegādes paziņojumu!",
    "Choose for which activities you want to get a push notification." : "Izvēlies, par kurām darbībām vēlies saņemt pašpiegādes paziņojumu!",
