OC.L10N.register(
    ...
    "_{parameterList} and {linkStart}%n more{linkEnd}_::_{parameterList} and {linkStart}%n more{linkEnd}_" : ["{parameterList} un {linkStart}%n vairāk{linkEnd}","{parameterList} un {linkStart}%n vairāk{linkEnd}","{parameterList} un {linkStart}%n vairāk{linkEnd}"],
