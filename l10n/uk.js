OC.L10N.register(
    ...
    "Mail" : "Пошта",
    "Stream" : "Потік",
    "This application enables users to view actions related to their files in Nextcloud." : "Додаток дозволяє користувачам переглядати дії над їх файлами у Nextcloud.",
    "This application enables users to view actions related to their files in Nextcloud.\n\t\tOnce enabled, users will see a new icon “Activity” in their apps menu.\n\t\tWhen clicked, a new page appears for users to track the activity related to files – from new files, to deleted files, move, rename, updates and shared activity.\n\t\tThe user can configure their individual activity settings in their personal menu.\n\t\tThis sets the type of activity to record, as well as whether to the user sees their own activities,\n\t\twhether these are only available online, and whether they get an email digest on a regular basis.\n\t\tMore information is available in the Activity documentation." : "Додаток дозволяє користувачам переглядати дії над їх файлами у Nextcloud.\n\t\tКоли додаток увімкнено, в меню додатків у користувачів з'являється новий значок  \"Активність\".\n\t\tПо натисканню на нього відкривається сторінка, на якій користувачі можуть відслідковувати активність пов'язану з файлами – створення та видалення файлів, їх переміщення, перейменування, оновлення та зміни у спільному доступі.\n\t\tКористувач може вказати власні налаштування активності у персональному меню.\n\t\tНалаштовується тип активності, що буде відслідковуватися, чи слід відображати користувачеві власну активність,\n\t\tє перегляд активності доступним лише онлайн, чи слід надсилати періодичні звіти на email.\n\t\tДодаткову інформацію наведено у довідці додатку Активність.",
