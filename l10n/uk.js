OC.L10N.register(
    ...
    "%s and %s" : "%s і %s",
    ", " : ",",
    "%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>::%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>" : [" "," "," %s і <strong class=\"tooltip\" title=\"%s\"> %n більше </strong> "],
    "%s and %n more::%s and %n more" : [" "," ","%s і %n більше"],
    "Hello %s," : "Привіт %s,",
