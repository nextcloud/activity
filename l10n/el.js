OC.L10N.register(
    ...
    "%s and %s" : "%s και %s",
    ", " : ", ",
    "%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>::%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>" : ["%s και <strong class=\"tooltip\" title=\"%s\"> %n περισσότερο</strong>","%s και <strong class=\"tooltip\" title=\"%s\"> %n περισσότερα</strong>"],
    "%s and %n more::%s and %n more" : ["%s και %n περισσότερο","%s και %n περισσότερα"],
    ...
    "Notify about your own actions via email" : "Ενημερώστε για τις δράσεις σας μέσω ηλ. ταχυδρομείου",
