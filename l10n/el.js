OC.L10N.register(
    ...
    "Enable notification emails" : "Ενεργοποίηση ειδοποιήσεων μέσω email",
    "Default settings" : "Προεπιλεγμένες ρυθμίσεις",
    "Configure the default notification settings for new users." : "Καθορίστε τις προεπιλεγμένες ρυθμίσεις για τους νέους χρήστες.",
    ...
    "Daily" : "Καθημερινά",
    "Weekly" : "Εβδομαδιαία",
    "Choose for which activities you want to get an email or push notification." : "Επιλέξτε για ποιες δραστηριότητες θα λαμβάνετε ειδοποιήσεις μέσω email ή στη συσκευή σας.",
    "Choose for which activities you want to get a push notification." : "Επιλέξτε για ποιες δραστηριότητες θα λαμβάνετε ειδοποιήσεις στη συσκευή σας.",
