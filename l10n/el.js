OC.L10N.register(
    ...
    "%s and %s" : "%s και %s",
    ", " : ", ",
    "_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_::_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_" : ["%s και <strong class=\"tooltip\" title=\"%s\"> %n περισσότερο</strong>","%s και <strong class=\"tooltip\" title=\"%s\"> %n περισσότερα</strong>"],
