OC.L10N.register(
    ...
    "Hello %s" : "Χαιρετώ το %s",
    "Hello %s," : "Καλώς ήρθατε %s,",
    ...
    "Configure the default activity settings for new users." : "Διαμόρφωσε τις προεπιλεγμένες ρυθμίσεις δραστηριότητας για τους νέους χρήστες.",
