OC.L10N.register(
    ...
    "You can disable daily digest emails in the <a href=\"%s\">settings</a>." : "<a href=\"%s\">설정에서</a> 일일 요약 이메일을 사용하지 않도록 설정할 수 있습니다.",
    "You can disable daily digest emails in the settings: %s" : "설정에서 일일 요약 이메일을 사용하지 않도록 설정할 수 있습니다: %s",
    ...
    "Configure the default notification settings for new accounts." : "새 사용자에 대한 알림 기본값을 설정하십시오.",
