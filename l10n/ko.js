OC.L10N.register(
    ...
    "Activity" : "활동",
    "Activity feed" : "활동 피드",
    "Send activity emails" : "활동 이메일을 보냄",
    ...
    "Choose which activities you want to see in the your stream." : "스트림에서 보고 싶은 활동들을 선택하세요.",
    "Settings" : "설정",
    "Enable RSS feed" : "RSS 피드 사용",
    "No more events to load" : "더 이상 불러올 이벤트 없음",
    "Files" : "파일",
    "Error loading activities" : "활동들을 로딩하는데 에러 발생",
    "No activities" : "활동 없음",
    "You are receiving this email because the following things happened at %s" : "%s에 다음과 같은 것들이 발생하여 본 이메일을 받게 된것입니다.",
    "* %1$s - %2$s" : "* %1$s - %2$s",
