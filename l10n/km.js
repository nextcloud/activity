OC.L10N.register(
    ...
    "%s and %s" : "%s និង %s",
    ", " : ", ",
    "%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>::%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>" : ["%s និង <strong class=\"tooltip\" title=\"%s\">%n ជាច្រើន</strong>"],
    "%s and %n more::%s and %n more" : ["%s និង %n ជាច្រើន"],
    "Hello %s," : "សួស្ដី %s,",
