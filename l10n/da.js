OC.L10N.register(
    ...
    "%s and %s" : "%s og %s",
    ", " : ", ",
    "_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_::_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_" : ["%s og <strong class=\"tooltip\" title=\"%s\">%n mere</strong>","%s og <strong class=\"tooltip\" title=\"%s\">%n andre</strong>"],
