OC.L10N.register(
    ...
    "{from} to {to}" : "{from} és {to} között",
    "Since {from}" : "Ezóta: {from}",
    "Until {to}" : "Eddig: {to}",
    "Enter at least {count} characters to search" : "A kereséshez adjon meg legalább {count} karaktert",
    "Search by file name" : "Keresés fájlnév alapján",
    "Clear search" : "Keresés törlése",
    "Filter by account" : "Szűrés fiók szerint",
    "Anyone" : "Bárki",
    "Filter activities by date" : "Tevékenységek szűrése dátum szerint",
    ...
    "Yesterday" : "Tegnap",
    "Loading activity summary" : "Tevékenység-összefoglaló betöltése",
    "_%n activity since {date}_::_%n activities since {date}_" : ["%n tevékenység {date} óta","%n tevékenység {date} óta"],
    "Colour shows how many activities happened on each day, from none to {max}." : "A szín azt jelenti, hogy hány tevékenység történt az egyes napokon, 0 és {max} között.",
    "_%n activity_::_%n activities_" : ["%n tevékenység","%n tevékenység"],
    "{date} — count incomplete" : "{date} – a számolás nem teljes",
    "_%n activity on {date}_::_%n activities on {date}_" : ["%n tevékenység ekkor: {date}","%n tevékenység ekkor: {date}"],
    "{label} (count incomplete)" : "{label} (a számolás nem teljes)",
    "Week of {date}" : "{date} hete",
    "Activity over time" : "Tevékenység az idők során",
    "Activity per day. Each cell is one day; use the arrow keys to move between days and Enter to filter the stream by that day." : "Napi tevékenység. Minden cella egy nap; használja a nyílbillentyűket a navigáláshoz, és nyomjon Entert a tevékenységfolyam adott napra szűréséhez.",
    "Less" : "Kevesebb",
    "More" : "Továbbiak",
    ...
    "No matching activities" : "Nincs megfelelő tevékenység",
    "No activity matches the current filters" : "Nincs a jelenlegi szűrőknek megfelelő tevékenység",
    ...
    "Show these activities" : "Ezen tevékenységek megjelenítése",
    "Show {date}" : "{date} megjelenítése",
    "Show {from} to {to}" : "Megjelenítés {from} és {to} között",
    "Pick a day to see what happened, or hold Shift and pick a second day for a period." : "Válasszon egy napon, hogy lássa mi történt, vagy tartsa lenyomva a Shiftet és válasszon egy másik napot egy időszak megadásához.",
    "Clear selection" : "Kiválasztás törlése",
    "Unable to load the activity list" : "A tevékenységlista betöltése sikertelen",
    "Loading older activities…" : "Régebbi tevékenységek betöltése…",
    "Load older activities" : "Régebbi tevékenységek betöltése",
