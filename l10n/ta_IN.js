OC.L10N.register(
    ...
    "%s and %s" : "%s மற்றும் %s",
    ", " : ".",
    "%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>::%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>" : ["%s மற்றும் <strong class=\"tooltip\" title=\"%s\">%n பல</strong>","%s மற்றும் <strong class=\"tooltip\" title=\"%s\">%n பல</strong>"],
    "%s and %n more::%s and %n more" : ["% s மற்றும்% n அதிகமாக.","% s மற்றும்% n அதிகமாக."],
    "Hello %s," : "வணக்கம் %s",
