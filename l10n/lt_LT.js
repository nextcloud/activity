OC.L10N.register(
    ...
    "%s and %s" : "%s ir %s",
    ", " : ",",
    "_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_::_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_" : ["%s ir <strong class=\"tooltip\" title=\"%s\">%n daugiau</strong>","%s ir <strong class=\"tooltip\" title=\"%s\">%n daugiau</strong>","%s ir <strong class=\"tooltip\" title=\"%s\">%n daugiau</strong>"],
