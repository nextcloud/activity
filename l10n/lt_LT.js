OC.L10N.register(
    ...
    "%s and %s" : "%s ir %s",
    ", " : ",",
    "%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>::%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>" : ["%s ir <strong class=\"tooltip\" title=\"%s\">%n daugiau</strong>","%s ir <strong class=\"tooltip\" title=\"%s\">%n daugiau</strong>","%s ir <strong class=\"tooltip\" title=\"%s\">%n daugiau</strong>"],
    "%s and %n more::%s and %n more" : ["%s ir %n daugiau","%s ir %n daugiau","%s ir %n daugiau"],
    "Hello %s," : "Sveiki %s,",
