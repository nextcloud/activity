OC.L10N.register(
    ...
    "%s and %s" : "%s eta %s",
    ", " : ", ",
    "%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>::%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>" : ["%s eta <strong class=\"tooltip\" title=\"%s\">%n gehiago</strong>","%s eta <strong class=\"tooltip\" title=\"%s\">%n gehiago</strong>"],
    "%s and %n more::%s and %n more" : ["%s eta %n gehiago","%s eta %n gehiago"],
    "Hello %s," : "Kaixo %s,",
