OC.L10N.register(
    ...
    "%s and %s" : "%s i %s",
    ", " : ", ",
    "%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>::%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>" : ["%s i <strong class=\"tooltip\" title=\"%s\">%n més</strong>","%s i <strong class=\"tooltip\" title=\"%s\">%n més</strong>"],
    "%s and %n more::%s and %n more" : ["%s i %n més","%s i %n més"],
    "Hello %s," : "Hola %s,",
