OC.L10N.register(
    ...
    "%s and %s" : "%s i %s",
    ", " : ", ",
    "_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_::_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_" : ["%s i <strong class=\"tooltip\" title=\"%s\">%n més</strong>","%s i <strong class=\"tooltip\" title=\"%s\">%n més</strong>"],
