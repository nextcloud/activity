OC.L10N.register(
    ...
    "%s and %s" : "%s и %s",
    ", " : ", ",
    "_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_::_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_" : ["%s и <strong class=\"tooltip\" title=\"%s\">още %n</strong>.","%s и <strong class=\"tooltip\" title=\"%s\">още %n</strong>."],
