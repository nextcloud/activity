OC.L10N.register(
    ...
    "%s and %s" : "%s și %s",
    ", " : ",",
    "_%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>_::_%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>_" : ["%s și <strong class=\"tooltip\" title=\"%s\">%n mai mult</strong>","%s și <strong class=\"tooltip\" title=\"%s\">%n mai mulți</strong>","%s și <strong class=\"tooltip\" title=\"%s\">%n mai mulți</strong>"],
