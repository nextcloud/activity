OC.L10N.register(
    ...
    "Stream" : "записник",
    "Activity" : "Активност",
    "This application enables users to view actions related to their files in Nextcloud." : "Ова апликација омогућава корисницима да виде акције везане за њихове Некстклауд фајлове.",
    "This application enables users to view actions related to their files in Nextcloud.\n\t\tOnce enabled, users will see a new icon “Activity” in their apps menu.\n\t\tWhen clicked, a new page appears for users to track the activity related to files – from new files, to deleted files, move, rename, updates and shared activity.\n\t\tThe user can configure their individual activity settings in their personal menu.\n\t\tThis sets the type of activity to record, as well as whether to the user sees their own activities,\n\t\twhether these are only available online, and whether they get an email digest on a regular basis.\n\t\tMore information is available in the Activity documentation." : "Ова апликација омогућава корисницима да виде акције везане за њихове Некстклауд фајлове.\n\t\tКада се укључи, корисници ће видети нову иконицу \"Активности\" у главном менију.\n\t\tКада се она кликне, појављује се нова страна где корисник прати активности везане за фајлове – од нових фајлова, до брисања фајлова, померања, преименовања, ажурирања и радњи дељења.\n\t\tКорисник може подесити индивидуалне поставке активности у личном менију.\n\t\tОвим се подешава које се активности бележе, као и да ли корисник види своје активности,\n\t\tда ли су активности доступне само на интернету, и да ли се редовно добија е-пошта са сажетком.\n\t\tВише информација је доступно у документацији за Активности.",
