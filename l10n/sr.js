OC.L10N.register(
    ...
    "Press ⌘-C to copy." : "Притисни ⌘-C да копираш",
    "Press Ctrl-C to copy." : "Притисни Ctrl-C да копираш",
    ...
    "%s and %s" : "%s и %s",
    "Hello %s," : "Здраво %s,",
    "There was some activity at %s" : "Било је промена у %s ",
    "- %1$s (%2$s)" : "- %1$s (%2$s) ",
    "_- and %n more _::_- and %n more _" : ["-  и још %n","-  и још %n","- и још %n"],
    "List your own actions in the stream" : "Додајте ваше акције у листу",
