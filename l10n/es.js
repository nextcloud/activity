OC.L10N.register(
    ...
    "Your feed URL is invalid" : "Su fuente URL es inválido",
    ...
    "_and %n more _::_and %n more _" : ["y 1%n más","and %n más "],
    ...
    "Choose for which activities you want to get an email notification, and which should show up in the activity app stream." : "Escoger para qué actividades se quiere conseguir una notificación por correo y cuál debería aparecer en el flujo de la app de Actividad.",
    "List your own actions in the stream" : "Enumerar sus propias acciones en el flujo",
    "Notify about your own actions via email" : "Notificarse sobre sus propias acciones por correo electrónico",
    ...
    "You are receiving this email because the following things happened at %s" : "Recibes este c orreo porque esto ha sucedido en %s",
    "* %1$s - %2$s" : "* %1$s - %2$s",
