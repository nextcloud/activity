OC.L10N.register(
    ...
    "_{parameterList} and {linkStart}%n more{linkEnd}_::_{parameterList} and {linkStart}%n more{linkEnd}_" : ["{parameterList} és {linkStart}%n több {linkEnd}","{parameterList} és {linkStart}%n több {linkEnd}"],
