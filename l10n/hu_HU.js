OC.L10N.register(
    ...
    "%s and %s" : "%s és %s",
    ", " : ", ",
    "_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_::_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_" : ["%s és <strong class=\"tooltip\" title=\"%s\">még %n</strong>","%s és <strong class=\"tooltip\" title=\"%s\">még %n</strong>"],
