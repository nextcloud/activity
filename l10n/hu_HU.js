OC.L10N.register(
    ...
    "%s and %s" : "%s és %s",
    ", " : ", ",
    "%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>::%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>" : ["%s és <strong class=\"tooltip\" title=\"%s\">még %n</strong>","%s és <strong class=\"tooltip\" title=\"%s\">még %n</strong>"],
    "%s and %n more::%s and %n more" : ["%s és még %n","%s és még %n"],
    "Hello %s," : "Üdv %s!",
