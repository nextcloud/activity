...
"%s and %s" => "%s dan %s",
", " => ", ",
"_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_::_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_" => array("%s dan <strong class=\"tooltip\" title=\"%s\">%n lainnya</strong>"),
"_%s and %n more_::_%s and %n more_" => array("%s dan %n lainnya"),
"Hello %s," => "Helo %s,",
