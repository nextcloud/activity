OC.L10N.register(
    ...
    "_{parameterList} and {linkStart}%n more{linkEnd}_::_{parameterList} and {linkStart}%n more{linkEnd}_" : ["{parameterList} ve {linkStart}%n daha fazla{linkEnd}","{parameterList} ve {linkStart}%n diğer{linkEnd}"],
    ...
    "List your own file actions in the stream" : "Kendi dosya işlemleriniz akışta görüntülensin",
