OC.L10N.register(
    ...
    "You can disable daily digest emails in the <a href=\"%s\">settings</a>." : "Du kan inaktivera dagliga sammanfattningsmejl i <a href=\"%s\">inställningarna</a>.",
    "You can disable daily digest emails in the settings: %s" : "Du kan inaktivera dagliga sammanfattningsmejl i inställningarna: %s",
    ...
    "Since {from}" : "Sedan {from}",
    "Until {to}" : "Till {to}",
    "Enter at least {count} characters to search" : "Ange minst {count} tecken för att söka",
    "Search by file name" : "Sök efter filnamn",
    "Clear search" : "Rensa sökning",
    "Filter by account" : "Filtrera efter konto",
    "Anyone" : "Vem som helst",
    "Filter activities by date" : "Filtrera aktiviteter efter datum",
    ...
    "Yesterday" : "Igår",
    "Loading activity summary" : "Läser in aktivitetsöversikt",
    "_%n activity since {date}_::_%n activities since {date}_" : ["%n aktivitet sedan {date}","%n aktiviteter sedan {date}"],
    "Colour shows how many activities happened on each day, from none to {max}." : "Färgen visar hur många aktiviteter som inträffade varje dag, från inga till {max}.",
    "_%n activity_::_%n activities_" : ["%n aktivitet","%n aktiviteter"],
    "{date} — count incomplete" : "{date} — ofullständigt antal",
    "_%n activity on {date}_::_%n activities on {date}_" : ["%n aktivitet den {date}","%n aktiviteter den {date}"],
    "{label} (count incomplete)" : "{label} (ofullständigt antal)",
    "Week of {date}" : "Veckan som börjar {date}",
    "Activity over time" : "Aktivitet över tid",
    "Activity per day. Each cell is one day; use the arrow keys to move between days and Enter to filter the stream by that day." : "Aktivitet per dag. Varje cell motsvarar en dag; använd piltangenterna för att flytta mellan dagar och Retur för att filtrera flödet efter den dagen.",
    "Less" : "Mindre",
    "More" : "Mer",
    ...
    "No matching activities" : "Inga matchande aktiviteter",
    "No activity matches the current filters" : "Inga aktiviteter matchar de aktuella filtren",
    ...
    "Show these activities" : "Visa dessa aktiviteter",
    "Show {date}" : "Visa {date}",
    "Show {from} to {to}" : "Visa {from} till {to}",
    "Pick a day to see what happened, or hold Shift and pick a second day for a period." : "Välj en dag för att se vad som hände, eller håll ned Skift och välj en andra dag för en period.",
    "Clear selection" : "Rensa markering",
    "Unable to load the activity list" : "Kunde inte ladda aktivitetslistan",
    "Loading older activities…" : "Läser in äldre aktiviteter …",
    "Load older activities" : "Läs in äldre aktiviteter",
