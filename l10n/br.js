OC.L10N.register(
    ...
    "Your settings have been updated." : "O stummoù a zo bet nevesaet",
    "Settings have been updated." : "Stummoù a zo bet adnevesaet",
    ...
    "Notify about your own actions via email" : "Kelaouiñ o oberennoù deoc'h dre email",
    "You need to set up your email address before you can receive notification emails." : "Ezhomp o peus lakaat o chom-lec'h email a raok kaout kemenadennoù dre o emailoù.",
    "Send emails:" : "Kas emailoù :",
    "As soon as possible" : "Diouzhtu p'az eo posupl",
    "Hourly" : "Pep heurvez",
    "Daily" : "Bemdeiz",
    "Weekly" : "Pep sizhun",
    "Choose for which activities you want to get an email notification, and which should show up in the activity app stream." : "Choazit evit peseurt oberiantiz o peus c'hoant kavout un gemenadenn dre email, ha peseurt re a vo diskouezet er red oberioù meziant.",
