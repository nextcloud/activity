OC.L10N.register(
    ...
    "Shares" : "Freigaben",
    "Files" : "Dateien",
    "\"remote user\"" : "\"Entfernter Nutzer\"",
    "in %s" : "unter %s",
    "%s and %s" : "%s und %s",
    ", " : ", ",
    "%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>::%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>" : ["%s und <strong class=\"tooltip\" title=\"%s\">%n mehr</strong>","%s und <strong class=\"tooltip\" title=\"%s\">%n weitere</strong>"],
    "%s and %n more::%s and %n more" : ["%s und %n mehr","%s und %n weitere"],
    "Hello %s," : "Hallo %s,",
