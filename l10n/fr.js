OC.L10N.register(
    ...
    "_%n activity since {date}_::_%n activities since {date}_" : ["%n activité depuis le {date}","%n activités depuis le {date}","%n activité(s) depuis le {date}"],
    ...
    "_%n activity on {date}_::_%n activities on {date}_" : ["%n activité le {date}","%n activités le {date}","%n activité(s) le {date}"],
