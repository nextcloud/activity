OC.L10N.register(
    ...
    "%s and %s" : "%s et %s",
    ", " : ", ",
    "_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_::_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_" : ["%s et <strong class=\"tooltip\" title=\"%s\">%n autre</strong>","%s et <strong class=\"tooltip\" title=\"%s\">%n autres</strong>"],
