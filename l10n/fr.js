OC.L10N.register(
    ...
    "%s and %s" : "%s et %s",
    ", " : ", ",
    "%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>::%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>" : ["%s et <strong class=\"tooltip\" title=\"%s\">%n autre</strong>","%s et <strong class=\"tooltip\" title=\"%s\">%n autres</strong>"],
    "%s and %n more::%s and %n more" : ["%s et %n autre","%s et %n autres"],
    "Hello %s," : "Bonjour %s,",
