OC.L10N.register(
    ...
    "Your feed URL is invalid" : "L’URL de votre flux d’activité n’est pas valide",
    ...
    "You can disable daily digest emails in the <a href=\"%s\">settings</a>." : "Vous pouvez désactiver les e-mails quotidiens récapitulatifs dans les <a href=\"%s\">paramètres</a>.",
    "You can disable daily digest emails in the settings: %s" : "Vous pouvez désactiver les e-mails quotidiens récapitulatifs dans les paramètres : %s",
    "All activities" : "Toutes les activités",
    "By others" : "Par d’autres personnes",
    "Focused" : "Vous concernant",
    "By you" : "Par vous",
    ...
    "This application enables people to view a log of activities about them, their files or other data." : "Cette application permet aux personnes de visualiser les logs des activités les concernant, leurs fichiers ou d’autres données.",
    ...
    "Since {from}" : "Depuis le {from}",
    "Until {to}" : "Jusqu’au {to}",
    "Enter at least {count} characters to search" : "Saisissez au moins {count} caractères pour effectuer une recherche",
    "Search by file name" : "Rechercher par nom de fichier",
    "Clear search" : "Effacer la recherche",
    "Filter by account" : "Filtrer par compte",
    "Anyone" : "Tout le monde",
    "Filter activities by date" : "Filtrer les activités par date",
    ...
    "Yesterday" : "Hier",
    "Loading activity summary" : "Chargement du résumé des activités",
    "_%n activity since {date}_::_%n activities since {date}_" : ["%n activité depuis le {date}","%n activités depuis le {date}","[2] %n activités depuis le {date}"],
    "Colour shows how many activities happened on each day, from none to {max}." : "La couleur indique le nombre d’activités survenues chaque jour, de zéro à {max}.",
    "_%n activity_::_%n activities_" : ["%n activité","%n activités","%n activités"],
    "{date} — count incomplete" : "{date} — décompte incomplet",
    "_%n activity on {date}_::_%n activities on {date}_" : ["%n activité le {date}","%n activités le {date}","[2] %n activités le {date}"],
    "{label} (count incomplete)" : "{label} (décompte incomplet)",
    "Week of {date}" : "Semaine du {date}",
    "Activity over time" : "Activité au fil du temps",
    "Activity per day. Each cell is one day; use the arrow keys to move between days and Enter to filter the stream by that day." : "Activités par jour. Chaque cellule représente une journée ; utilisez les touches fléchées pour vous déplacer entre les jours et Entrée pour filtrer le flux du jour ainsi sélectionné.",
    "Less" : "Moins",
    "More" : "Plus",
    "_Downloaded %n time (%s in the last 30 days)_::_Downloaded %n times (%s in the last 30 days)_" : ["Téléchargé %n fois (%s sur les 30 derniers jours)","Téléchargé %n fois (%s sur les 30 derniers jours)","Téléchargé %n fois (%s sur les 30 derniers jours)"],
    "_Downloaded %n time_::_Downloaded %n times_" : ["Téléchargé %n fois","Téléchargé %n fois","Téléchargé %n fois"],
    ...
    "No matching activities" : "Aucune activité correspondante",
    ...
    "Show these activities" : "Afficher ces activités",
    "Show {date}" : "Afficher le {date}",
    "Show {from} to {to}" : "Afficher du {from} au {to}",
    "Pick a day to see what happened, or hold Shift and pick a second day for a period." : "Sélectionnez un jour pour voir ce qui s’est passé, ou maintenez la touche Maj enfoncée et sélectionnez un second jour pour définir une période.",
    "Clear selection" : "Annuler la sélection",
    "Unable to load the activity list" : "Impossible de charger la liste des activités",
    "Loading older activities…" : "Chargement des activités plus anciennes…",
    "Load older activities" : "Charger les activités plus anciennes",
