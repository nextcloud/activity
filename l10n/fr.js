OC.L10N.register(
    ...
    "This application enables users to view actions related to their files in Nextcloud.\n\t\tOnce enabled, users will see a new icon “Activity” in their apps menu.\n\t\tWhen clicked, a new page appears for users to track the activity related to files – from new files, to deleted files, move, rename, updates and shared activity.\n\t\tThe user can configure their individual activity settings in their personal menu.\n\t\tThis sets the type of activity to record, as well as whether to the user sees their own activities,\n\t\twhether these are only available online, and whether they get an email digest on a regular basis.\n\t\tMore information is available in the Activity documentation." : "Cette application permet aux utilisateurs de voir les actions concernant leurs fichiers dans Nextcloud.\n\t\tUne fois activée, les utilisateurs verront une nouvelle icône \"Activité\" dans leur menu d'applications.\n\t\tLorsque l'on clique dessus, une nouvelle page apparaît permettant aux utilisateurs de suivre l'activité concernant les fichiers – des nouveaux fichiers, à ceux supprimés, en passant par ceux déplacés, renommés, les mises à jour et les partages.\n\t\tL'utilisateur peut configurer ses paramètres d'activité individuelle dans son menu personnel.\n\t\tLe type d'activité à enregistrer y est définie, ainsi que la possibilité pour l'utilisateur de voir ses propres activités,\n\t\tde même que la possibilité de rendre celles-ci visibles en ligne uniquement, et si un résumé doit être envoyé par E-mail sur base régulière.\n\t\tPlus d'informations peuvent être obtenues dans la documentation d'Activité.",
    "Activity feed" : "Fil d'activité",
    "Send activity emails" : "Envoyer les courriels d'activité",
