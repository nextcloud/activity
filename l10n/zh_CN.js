OC.L10N.register(
    ...
    "You can disable daily digest emails in the <a href=\"%s\">settings</a>." : "您可以在<a href=\"%s\">设置</a>中禁用每日摘要邮件。",
    "You can disable daily digest emails in the settings: %s" : "您可以在设置中禁用每日摘要邮件：%s",
    "All activities" : "所有动态",
    "By others" : "他人动态",
    "By you" : "你的动态",
    "Activity at %s" : "%s 的动态",
    ...
    "You can change the frequency of these emails or disable them in the <a href=\"%s\">settings</a>." : "您可以更改这些邮件的频率或在<a href=\"%s\">设置</a>中禁用它们。",
    "You can change the frequency of these emails or disable them in the settings: %s" : "您可以更改这些邮件的频率或在设置中禁用它们：%s",
    "Mail" : "邮件",
    "Push" : "推送",
    "Activity" : "动态",
    "Notifications" : "通知",
    ...
    "Today" : "今天",
    "Yesterday" : "昨天",
    "_Downloaded %n time (%s in the last 30 days)_::_Downloaded %n times (%s in the last 30 days)_" : ["下载了 %n 次 (%s 次在最近30天内)"],
    "_Downloaded %n time_::_Downloaded %n times_" : ["下载了 %n 次"],
    ...
    "RSS link copied to clipboard" : "RSS 链接已复制至剪贴板",
    "Could not copy the RSS link, please copy manually:" : "无法复制 RSS 链接，请手动进行复制操作：",
