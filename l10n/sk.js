OC.L10N.register(
    ...
    "in {path}" : "v {path}",
    "This stream will show events like additions, changes & shares" : "Tento dátový prúd zobrazuje udalosti ako pridanie, zmeny a sprístupnenie",
    ...
    "Choose for which activities you want to get an email notification, and which should show up in the activity app stream." : "Vyberte na ktoré aktivity chcete byť upozornení emailovou notifikáciou a ktore sa majú zobraziť v dátovom prúde.",
    "List your own actions in the stream" : "Zoznam vlastných činností v dátovom prúde",
