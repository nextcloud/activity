OC.L10N.register(
    ...
    "%s and %s" : "%s og %s",
    ", " : ", ",
    "_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_::_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_" : ["%s og <strong class=\"tooltip\" title=\"%s\">%n til</strong>","%s og <strong class=\"tooltip\" title=\"%s\">%n flere</strong>"],
    "_%s and %n more_::_%s and %n more_" : ["%s og %n til","%s og %n flere"],
    "Hello %s," : "Hei %s,",
