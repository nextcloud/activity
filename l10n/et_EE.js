OC.L10N.register(
    ...
    "%s and %s" : "%s ja %s",
    ", " : ", ",
    "_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_::_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_" : ["%s ja <strong class=\"tooltip\" title=\"%s\">%n veel</strong>","%s ja <strong class=\"tooltip\" title=\"%s\">%n veel</strong>"],
