OC.L10N.register(
    ...
    "remote user" : "оддалечен корисник",
    ...
    "You can disable daily digest emails in the <a href=\"%s\">settings</a>." : "Можете да ги оневозможите дневните е-пораки во <a href=\"%s\">поставките</a>.",
    "You can disable daily digest emails in the settings: %s" : "Можете да ги оневозможите дневните е-пораки во поставките: %s",
    ...
    "Yesterday" : "Вчера",
    "_%n activity_::_%n activities_" : ["%n активност","%n активности"],
    "_%n activity on {date}_::_%n activities on {date}_" : ["%n активност на {date}","%n активности на {date}"],
    "Less" : "Помалку",
    "More" : "Повеќе",
    "_Downloaded %n time (%s in the last 30 days)_::_Downloaded %n times (%s in the last 30 days)_" : ["Преземено %n пати (%s во последните 30 дена)","Преземено %n пати (%s во последните 30 дена)"],
    "_Downloaded %n time_::_Downloaded %n times_" : ["Преземено %n пати","Преземено %n пати"],
    ...
    "New activities" : "Нови активности",
    ...
    "Show {date}" : "Прикажи {date}",
    "Show {from} to {to}" : "Прикажи {from} до {to}",
    "Clear selection" : "Исчисти ги селектираните",
    "Unable to load the activity list" : "Неможе да се вчита листата на активности",
    "Loading older activities…" : "Вчитување постари активности...",
    "Load older activities" : "Вчитај постари активности",
