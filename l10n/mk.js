OC.L10N.register(
    ...
    "{name} (invisible)" : "{име} (невидливо)",
    "{name} (restricted)" : "{име} (ограчничено)",
    "Home" : "Дома",
    "in {path}" : "во {патека}",
    ...
    "Your settings have been updated." : "Вашите поставки беа ажурирани.",
    "Settings have been updated." : "Поставките се ажурирани.",
