OC.L10N.register(
    ...
    "%s and %s" : "%s oraz %s",
    ", " : ", ",
    "%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>::%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>" : ["%s i <strong class=\"tooltip\" title=\"%s\">%n więcej</strong>","%s i <strong class=\"tooltip\" title=\"%s\">%n więcej</strong>","%s i <strong class=\"tooltip\" title=\"%s\">%n więcej</strong>"],
    "%s and %n more::%s and %n more" : ["%s i %n więcej","%s i %n więcej","%s i %n więcej"],
    "Hello %s," : "Witaj %s,",
