...
"%s and %s" => "%s і %s",
", " => ",",
"_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_::_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_" => array(" "," "," %s і <strong class=\"tooltip\" title=\"%s\"> %n більше </strong> "),
"_%s and %n more_::_%s and %n more_" => array(" "," ","%s і %n більше"),
"Hello %s," => "Привіт %s,",
