OC.L10N.register(
    ...
    "%s and %s" : "%sഉം %sഉം",
    ", " : ",",
    "_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_::_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_" : ["%sഉം <strong class=\"tooltip\" title=\"%s\">%n എണ്ണം കൂടുതലും</strong>","%sഉം <strong class=\"tooltip\" title=\"%s\">%n എണ്ണം കൂടുതലും</strong>"],
