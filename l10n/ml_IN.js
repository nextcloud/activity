OC.L10N.register(
    ...
    "%s and %s" : "%sഉം %sഉം",
    ", " : ",",
    "%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>::%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>" : ["%sഉം <strong class=\"tooltip\" title=\"%s\">%n എണ്ണം കൂടുതലും</strong>","%sഉം <strong class=\"tooltip\" title=\"%s\">%n എണ്ണം കൂടുതലും</strong>"],
    "%s and %n more::%s and %n more" : ["%sഉം %n എണ്ണം കൂടുതലും","%sഉം %n എണ്ണം കൂടുതലും"],
    "Hello %s," : "നമസ്കാരം %s, ",
