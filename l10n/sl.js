OC.L10N.register(
    ...
    "%s and %s" : "%s in %s",
    ", " : ",",
    "_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_::_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_" : ["%s in <strong class=\"tooltip\" title=\"%s\">%n več</strong>","%s in <strong class=\"tooltip\" title=\"%s\">%n več</strong>","%s in <strong class=\"tooltip\" title=\"%s\">%n več</strong>","%s in <strong class=\"tooltip\" title=\"%s\">%n več</strong>"],
