OC.L10N.register(
    ...
    "%s and %s" : "%s و %s",
    "Hello %s," : "مرحبا %s,",
    "You are receiving this email because the following things happened at %s" : "أنت تستقبل هذا البريد الإلكتروني لان العمليات التالية تم تنفيذها على %s",
    "* %1$s - %2$s" : "* %1$s - %2$s",
    "_* and %n more _::_* and %n more _" : ["* و %n بعد","* و %n بعد","* و %n بعد","* و %n بعد","* و %n بعد","* و %n المزيد"],
    "List your own file actions in the stream" : "اعرض العمليات التي تتم على ملفاتي في التدفق",
