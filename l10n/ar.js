OC.L10N.register(
    ...
    "Activity" : "حركات",
    "Personal activity feed for %s" : "تغذية الحركات الشخصية لـ%s",
    ...
    "No activities" : "لا توجد حركات",
    "More activities" : "نشاطات إضافية",
    ...
    "You need to set up your email address before you can receive notification emails." : "عليك إضافة بريدك الإلكتروني قبل تلقي رسائل بالإشعارات.",
    "Send activity emails" : "أرسل إيميل عن الحركة",
    ...
    "Choose for which activities you want to get an email or push notification." : "اختر الحركات التي تريد تلقّي بريد إلكتروني أو إشعار بها.",
    ...
    "Send daily activity summary in the morning" : "أرسل خلاصة حركة اليوم في الصباح",
