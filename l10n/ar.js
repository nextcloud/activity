OC.L10N.register(
    ...
    "Activity feed for %1$s" : "خلاصة الأنشطة لـ %1$s",
    ...
    "No activities" : "لا توجد أيّة أنشطة",
    "More activities" : "المزيد من الأنشطة",
    "Daily activity summary for %s" : "ملخص الأنشطة اليومية لـ%s",
    "_and %n more…_::_and %n more…_" : ["و %n أخرى …","و %n أخرى …","و %n أخرى …","و %n أخرى …","و %n أخرى …","و %n أخرى …"],
    "All activities" : "جميع الأنشطة",
    "By others" : "بواسطة آخرين",
    "By you" : "بواسطتك",
    "Activity at %s" : "الأنشطة في %s",
    "Hello %s" : "أهلاً %s",
    "Hello %s," : "أهلاً %s،",
    ...
    "Send activity emails" : "أرسِل إيميل عن النشاط",
    ...
    "No activity yet" : "لا توجد أيّة أنشطة حتى الأن",
    "Loading more activities" : "تحميل المزيد من الأنشطة",
    "No more activities." : "لا توجد أيّة الأنشطة.",
    ...
    "Could not load activites" : "تعذّر تحميل الأنشطة"
},
