OC.L10N.register(
    ...
    "Daily activity summary for %s" : "ملخص الأنشطة اليومية لـ%s",
    ...
    "Hello %s" : "أهلاً %s",
    "Hello %s," : "أهلاً %s،",
    "There was some activity at %s" : "كانت هنالك بعض الأنشطة عند %s",
    "Mail" : "البريد",
    "Push" : "أرسل",
    ...
    "Activity notification configuration" : "إعدادات تنبيهات النشاط",
    ...
    "Choose for which activities you want to get an email or push notification." : "اختر الأنشطة التي تريد تلقّي بريد إلكتروني أو إشعار عنها.",
    ...
    "This application enables users to view a log of activities about them or about files." : "هذا التطبيق يُمكّن المستخدمين من عرض سجل الأنشطة حول أو عن الملفات.",
