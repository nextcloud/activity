OC.L10N.register(
    ...
    "%s and %s" : "%s en %s",
    ", " : ", ",
    "_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_::_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_" : ["%s en <strong class=\"tooltip\" title=\"%s\">%n meer</strong>","%s en <strong class=\"tooltip\" title=\"%s\">%n meer</strong>"],
    "_%s and %n more_::_%s and %n more_" : ["%s en %n meer","%s en %n meer"],
    "Hello %s," : "Hallo %s,",
