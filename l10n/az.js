OC.L10N.register(
    ...
    "%s and %s" : "%s və %s",
    ", " : ",",
    "%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>::%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>" : ["%s və <strong class=\"tooltip\" title=\"%s\">%n daha da</strong>","%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>"],
    "%s and %n more::%s and %n more" : ["%s and %n more","%s və %n daha da"],
    "Hello %s," : "Salam %s,",
