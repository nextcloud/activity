OC.L10N.register(
    ...
    "Hello %s" : "Hei %s",
    "Hello %s," : "Hei %s,",
    "There was some activity at %s" : "Jotain tapahtumia oli kohteessa %s",
    "_and %n more _::_and %n more _" : ["ja %n lisää","ja %n lisää"],
    "Mail" : "Sähköposti",
    "Stream" : "Luettelo",
    "This application enables users to view actions related to their files in Nextcloud." : "Tämä sovellus sallii käyttäjän Nextcloud tiedostojen tapahtumien tarkastelun.",
