OC.L10N.register(
    ...
    "%s and %s" : "%s এবং %s",
    ", " : ",",
    "%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>::%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>" : ["%s এবং <strong class=\"tooltip\" title=\"%s\">%n বেশী</strong>","%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>"],
    "%s and %n more::%s and %n more" : ["%s এবং %n বেশী","%s and %n more"],
    "Hello %s," : "হেলো %s, ",
