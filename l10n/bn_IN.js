OC.L10N.register(
    ...
    "%s and %s" : "%s এবং %s",
    ", " : ",",
    "_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_::_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_" : ["%s এবং <strong class=\"tooltip\" title=\"%s\">%n বেশী</strong>","%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>"],
