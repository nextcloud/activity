...
"Activity" => "Активност",
"A file or folder has been <strong>shared</strong>" => "Файлът или директорията е <strong>споделен</strong>.",
"A new file or folder has been <strong>created</strong>" => "Нов файл или директория беше <strong>създаден</strong>.",
"A file or folder has been <strong>changed</strong>" => "Файл или директория беше <strong>променен</strong>.",
"A file or folder has been <strong>deleted</strong>" => "Файл или директория беше <strong>изтрит</strong>.",
...
"* %s" => "* %s",
"You will see a list of events here when you start to use your %s." => "Тук ще виждаш списък на събития, когато започнеш да ползваш твоят %s.",
