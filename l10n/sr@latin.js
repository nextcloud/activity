OC.L10N.register(
    ...
    "%s and %s" : "%s i %s",
    ", " : ", ",
    "_%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>_::_%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>_" : ["%s i <strong class=\"tooltip\" title=\"%s\">%n drugih</strong>","%s i <strong class=\"tooltip\" title=\"%s\">%n drugih</strong>","%s i <strong class=\"tooltip\" title=\"%s\">%n drugih</strong>"],
