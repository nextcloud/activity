OC.L10N.register(
    ...
    "%s and %s" : "%s এবং %s",
    ", " : ", ",
    "_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_::_%s and <strong class=\_tooltip\_ title=\_%s\_>%n more</strong>_" : ["%s and <strong class=\"টিপস\" title=\"%s\">%n more</strong>","%s and <strong class=\"টিপস\" title=\"%s\">%n more</strong>"],
