OC.L10N.register(
    ...
    "%s and %s" : "%s dan %s",
    ", " : ", ",
    "%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>::%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>" : ["%s dan <strong class=\"tooltip\" title=\"%s\">%n lainnya</strong>"],
    "%s and %n more::%s and %n more" : ["%s dan %n lainnya"],
    "Hello %s," : "Helo %s,",
