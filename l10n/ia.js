OC.L10N.register(
    ...
    "%s and %s" : "%s e %s",
    ", " : ", ",
    "%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>::%s and <strong class=\"tooltip\" title=\"%s\">%n more</strong>" : ["%s e <strong class=\"tooltip\" title=\"%s\">%n altere</strong>","%s e <strong class=\"tooltip\" title=\"%s\">%n altere</strong>"],
    "%s and %n more::%s and %n more" : ["%s e %n altere","%s e %n altere"],
    "Hello %s," : "Salute %s,",
