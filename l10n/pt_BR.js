OC.L10N.register(
    ...
    "Daily activity summary for %s" : "Resumo de atividades diário para %s",
    "_and %n more…_::_and %n more…_" : ["e mais %n…","e mais %n…","e mais %n…"],
    "You can disable daily digest emails in the <a href=\"%s\">settings</a>." : "Você pode desativar os e-mails diários com resumos nas <a href=\"%s\">configurações</a>.",
    "You can disable daily digest emails in the settings: %s" : "Você pode desativar os e-mails diários com resumos nas configurações: %s",
    "All activities" : "Todas as atividades",
    "By others" : "Por outros",
    "By you" : "Por você",
    "Activity at %s" : "Atividades em %s",
    "Hello %s" : "Olá %s",
    "Hello %s," : "Olá %s,",
    ...
    "_Downloaded %n time_::_Downloaded %n times_" : ["Baixado %n vez","Baixado %n de vezes","Baixado %n vezes"],
    ...
    "No matching activities" : "Não há atividades correspondentes",
    ...
    "New activities" : "Novas atividades",
    "Loading more activities" : "Carregando mais atividades",
    "No more activities." : "Não há mais atividades.",
    ...
    "Send daily activity summary in the morning" : "Enviar resumo diário das atividades pela manhã",
    "Default settings" : "Configurações padrão",
    "Configure the default notification settings for new accounts." : "Configure as definições de notificação padrão para novas contas.",
