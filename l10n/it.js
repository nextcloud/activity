OC.L10N.register(
    ...
    "Anyone" : "Chiunque",
    "Filter activities by date" : "Filtra le attività per data",
    ...
    "Yesterday" : "Ieri",
    "Loading activity summary" : "Caricamento riepilogo attività",
    "Activity per day. Each cell is one day; use the arrow keys to move between days and Enter to filter the stream by that day." : "Attività giornaliera. Ogni cella rappresenta un giorno; usa i tasti freccia per spostarti tra i giorni e Invio per filtrare il flusso in base al giorno selezionato.",
    "Less" : "Meno",
    "More" : "Altro",
    ...
    "No matching activities" : "Nessuna attività corrispondente",
    "No activity matches the current filters" : "Nessuna attività corrisponde ai filtri attuali",
    ...
    "Show these activities" : "Mostra queste attività",
    "Pick a day to see what happened, or hold Shift and pick a second day for a period." : "Seleziona un giorno per vedere cosa è successo, oppure tieni premuto Maiusc e seleziona un secondo giorno per visualizzare un periodo.",
    "Clear selection" : "Cancella selezione",
    "Unable to load the activity list" : "Impossibile caricare l'elenco delle attività",
    "Loading older activities…" : "Caricamento delle attività precedenti…",
    "Load older activities" : "Carica attività precedenti",
