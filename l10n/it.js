OC.L10N.register(
    ...
    "This application enables people to view a log of activities about them, their files or other data." : "Questa applicazione consente agli utenti di visualizzare lo storico delle loro attività o dei file.",
    "This app allows people to see actions related to their files and data in Nextcloud.\n\t\tEach person can configure their individual activity settings in the personal settings,\n\t\tto choose which activity should be pushed to mobile phones, sent via email\n\t\tor whether a daily summary is sent each morning.\n\t\tMore information is available in the Activity documentation." : "Questa applicazione consente agli utenti di vedere le azioni possibili per i loro file o dati in Nextcloud. \t\tChiunque può configurare impostazioni personalizzate delle proprie attività, nelle proprie impostazioni generali. \t\tPer scegliere quale attività deve essere trasmessa via \"push\" ai dispositivi mobili o inviata via email \t\t o se inviare un rapporto giornaliero ogni mattina. \t\t Maggiori informazioni sono disponibili nella documentazione delle \"Atttività\".",
