...
import{p as L}from"./logger.chunk.mjs";import{c as N,g as U}from"./_commonjsHelpers.chunk.mjs";import{g as B}from"./NcCheckboxRadioSwitch-hel9-sAH.chunk.mjs";function c(e){if(typeof e!="string")throw new TypeError("Path must be a string. Received "+JSON.stringify(e))}function y(e,a){for(var t="",r=0,l=-1,n=0,s,o=0;o<=e.length;++o){if(o<e.length)s=e.charCodeAt(o);else{if(s===47)break;s=47}if(s===47){if(!(l===o-1||n===1))if(l!==o-1&&n===2){if(t.length<2||r!==2||t.charCodeAt(t.length-1)!==46||t.charCodeAt(t.length-2)!==46){if(t.length>2){var m=t.lastIndexOf("/");if(m!==t.length-1){m===-1?(t="",r=0):(t=t.slice(0,m),r=t.length-1-t.lastIndexOf("/")),l=o,n=0;continue}}else if(t.length===2||t.length===1){t="",r=0,l=o,n=0;continue}}a&&(t.length>0?t+="/..":t="..",r=2)}else t.length>0?t+="/"+e.slice(l+1,o):t=e.slice(l+1,o),r=o-l-1;l=o,n=0}else s===46&&n!==-1?++n:n=-1}return t}function S(e,a){var t=a.dir||a.root,r=a.base||(a.name||"")+(a.ext||"");return t?t===a.root?t+r:t+e+r:r}var h={resolve:function(){for(var e="",a=!1,t,r=arguments.length-1;r>=-1&&!a;r--){var l;r>=0?l=arguments[r]:(t===void 0&&(t=L.cwd()),l=t),c(l),l.length!==0&&(e=l+"/"+e,a=l.charCodeAt(0)===47)}return e=y(e,!a),a?e.length>0?"/"+e:"/":e.length>0?e:"."},normalize:function(e){if(c(e),e.length===0)return".";var a=e.charCodeAt(0)===47,t=e.charCodeAt(e.length-1)===47;return e=y(e,!a),e.length===0&&!a&&(e="."),e.length>0&&t&&(e+="/"),a?"/"+e:e},isAbsolute:function(e){return c(e),e.length>0&&e.charCodeAt(0)===47},join:function(){if(arguments.length===0)return".";for(var e,a=0;a<arguments.length;++a){var t=arguments[a];c(t),t.length>0&&(e===void 0?e=t:e+="/"+t)}return e===void 0?".":h.normalize(e)},relative:function(e,a){if(c(e),c(a),e===a||(e=h.resolve(e),a=h.resolve(a),e===a))return"";for(var t=1;t<e.length&&e.charCodeAt(t)===47;++t);for(var r=e.length,l=r-t,n=1;n<a.length&&a.charCodeAt(n)===47;++n);for(var s=a.length,o=s-n,m=l<o?l:o,i=-1,u=0;u<=m;++u){if(u===m){if(o>m){if(a.charCodeAt(n+u)===47)return a.slice(n+u+1);if(u===0)return a.slice(n+u)}else l>m&&(e.charCodeAt(t+u)===47?i=u:u===0&&(i=0));break}var g=e.charCodeAt(t+u),p=a.charCodeAt(n+u);if(g!==p)break;g===47&&(i=u)}var d="";for(u=t+i+1;u<=r;++u)(u===r||e.charCodeAt(u)===47)&&(d.length===0?d+="..":d+="/..");return d.length>0?d+a.slice(n+i):(n+=i,a.charCodeAt(n)===47&&++n,a.slice(n))},_makeLong:function(e){return e},dirname:function(e){if(c(e),e.length===0)return".";for(var a=e.charCodeAt(0),t=a===47,r=-1,l=!0,n=e.length-1;n>=1;--n)if(a=e.charCodeAt(n),a===47){if(!l){r=n;break}}else l=!1;return r===-1?t?"/":".":t&&r===1?"//":e.slice(0,r)},basename:function(e,a){if(a!==void 0&&typeof a!="string")throw new TypeError('"ext" argument must be a string');c(e);var t=0,r=-1,l=!0,n;if(a!==void 0&&a.length>0&&a.length<=e.length){if(a.length===e.length&&a===e)return"";var s=a.length-1,o=-1;for(n=e.length-1;n>=0;--n){var m=e.charCodeAt(n);if(m===47){if(!l){t=n+1;break}}else o===-1&&(l=!1,o=n+1),s>=0&&(m===a.charCodeAt(s)?--s===-1&&(r=n):(s=-1,r=o))}return t===r?r=o:r===-1&&(r=e.length),e.slice(t,r)}else{for(n=e.length-1;n>=0;--n)if(e.charCodeAt(n)===47){if(!l){t=n+1;break}}else r===-1&&(l=!1,r=n+1);return r===-1?"":e.slice(t,r)}},extname:function(e){c(e);for(var a=-1,t=0,r=-1,l=!0,n=0,s=e.length-1;s>=0;--s){var o=e.charCodeAt(s);if(o===47){if(!l){t=s+1;break}continue}r===-1&&(l=!1,r=s+1),o===46?a===-1?a=s:n!==1&&(n=1):a!==-1&&(n=-1)}return a===-1||r===-1||n===0||n===1&&a===r-1&&a===t+1?"":e.slice(a,r)},format:function(e){if(e===null||typeof e!="object")throw new TypeError('The "pathObject" argument must be of type Object. Received type '+typeof e);return S("/",e)},parse:function(e){c(e);var a={root:"",dir:"",base:"",ext:"",name:""};if(e.length===0)return a;var t=e.charCodeAt(0),r=t===47,l;r?(a.root="/",l=1):l=0;for(var n=-1,s=0,o=-1,m=!0,i=e.length-1,u=0;i>=l;--i){if(t=e.charCodeAt(i),t===47){if(!m){s=i+1;break}continue}o===-1&&(m=!1,o=i+1),t===46?n===-1?n=i:u!==1&&(u=1):n!==-1&&(u=-1)}return n===-1||o===-1||u===0||u===1&&n===o-1&&n===s+1?o!==-1&&(s===0&&r?a.base=a.name=e.slice(1,o):a.base=a.name=e.slice(s,o)):(s===0&&r?(a.name=e.slice(1,n),a.base=e.slice(1,o)):(a.name=e.slice(s,n),a.base=e.slice(s,o)),a.ext=e.slice(n,o)),s>0?a.dir=e.slice(0,s-1):r&&(a.dir="/"),a},sep:"/",delimiter:":",win32:null,posix:null};h.posix=h;var C={exports:{}};(function(e){(function(a,t){e.exports?e.exports=t():a.Toastify=t()})(N,function(a){var t=function(s){return new t.lib.init(s)},r="1.12.0";t.defaults={oldestFirst:!0,text:"Toastify is awesome!",node:void 0,duration:3e3,selector:void 0,callback:function(){},destination:void 0,newWindow:!1,close:!1,gravity:"toastify-top",positionLeft:!1,position:"",backgroundColor:"",avatar:"",className:"",stopOnFocus:!0,onClick:function(){},offset:{x:0,y:0},escapeMarkup:!0,ariaLive:"polite",style:{background:""}},t.lib=t.prototype={toastify:r,constructor:t,init:function(s){return s||(s={}),this.options={},this.toastElement=null,this.options.text=s.text||t.defaults.text,this.options.node=s.node||t.defaults.node,this.options.duration=s.duration===0?0:s.duration||t.defaults.duration,this.options.selector=s.selector||t.defaults.selector,this.options.callback=s.callback||t.defaults.callback,this.options.destination=s.destination||t.defaults.destination,this.options.newWindow=s.newWindow||t.defaults.newWindow,this.options.close=s.close||t.defaults.close,this.options.gravity=s.gravity==="bottom"?"toastify-bottom":t.defaults.gravity,this.options.positionLeft=s.positionLeft||t.defaults.positionLeft,this.options.position=s.position||t.defaults.position,this.options.backgroundColor=s.backgroundColor||t.defaults.backgroundColor,this.options.avatar=s.avatar||t.defaults.avatar,this.options.className=s.className||t.defaults.className,this.options.stopOnFocus=s.stopOnFocus===void 0?t.defaults.stopOnFocus:s.stopOnFocus,this.options.onClick=s.onClick||t.defaults.onClick,this.options.offset=s.offset||t.defaults.offset,this.options.escapeMarkup=s.escapeMarkup!==void 0?s.escapeMarkup:t.defaults.escapeMarkup,this.options.ariaLive=s.ariaLive||t.defaults.ariaLive,this.options.style=s.style||t.defaults.style,s.backgroundColor&&(this.options.style.background=s.backgroundColor),this},buildToast:function(){if(!this.options)throw"Toastify is not initialized";var s=document.createElement("div");s.className="toastify on "+this.options.className,this.options.position?s.className+=" toastify-"+this.options.position:this.options.positionLeft===!0?(s.className+=" toastify-left",console.warn("Property `positionLeft` will be depreciated in further versions. Please use `position` instead.")):s.className+=" toastify-right",s.className+=" "+this.options.gravity,this.options.backgroundColor&&console.warn('DEPRECATION NOTICE: "backgroundColor" is being deprecated. Please use the "style.background" property.');for(var o in this.options.style)s.style[o]=this.options.style[o];if(this.options.ariaLive&&s.setAttribute("aria-live",this.options.ariaLive),this.options.node&&this.options.node.nodeType===Node.ELEMENT_NODE)s.appendChild(this.options.node);else if(this.options.escapeMarkup?s.innerText=this.options.text:s.innerHTML=this.options.text,this.options.avatar!==""){var m=document.createElement("img");m.src=this.options.avatar,m.className="toastify-avatar",this.options.position=="left"||this.options.positionLeft===!0?s.appendChild(m):s.insertAdjacentElement("afterbegin",m)}if(this.options.close===!0){var i=document.createElement("button");i.type="button",i.setAttribute("aria-label","Close"),i.className="toast-close",i.innerHTML="&#10006;",i.addEventListener("click",function(f){f.stopPropagation(),this.removeElement(this.toastElement),window.clearTimeout(this.toastElement.timeOutValue)}.bind(this));var u=window.innerWidth>0?window.innerWidth:screen.width;(this.options.position=="left"||this.options.positionLeft===!0)&&u>360?s.insertAdjacentElement("afterbegin",i):s.appendChild(i)}if(this.options.stopOnFocus&&this.options.duration>0){var g=this;s.addEventListener("mouseover",function(f){window.clearTimeout(s.timeOutValue)}),s.addEventListener("mouseleave",function(){s.timeOutValue=window.setTimeout(function(){g.removeElement(s)},g.options.duration)})}if(typeof this.options.destination<"u"&&s.addEventListener("click",function(f){f.stopPropagation(),this.options.newWindow===!0?window.open(this.options.destination,"_blank"):window.location=this.options.destination}.bind(this)),typeof this.options.onClick=="function"&&typeof this.options.destination>"u"&&s.addEventListener("click",function(f){f.stopPropagation(),this.options.onClick()}.bind(this)),typeof this.options.offset=="object"){var p=l("x",this.options),d=l("y",this.options),T=this.options.position=="left"?p:"-"+p,E=this.options.gravity=="toastify-top"?d:"-"+d;s.style.transform="translate("+T+","+E+")"}return s},showToast:function(){this.toastElement=this.buildToast();var s;if(typeof this.options.selector=="string"?s=document.getElementById(this.options.selector):this.options.selector instanceof HTMLElement||typeof ShadowRoot<"u"&&this.options.selector instanceof ShadowRoot?s=this.options.selector:s=document.body,!s)throw"Root element is not defined";var o=t.defaults.oldestFirst?s.firstChild:s.lastChild;return s.insertBefore(this.toastElement,o),t.reposition(),this.options.duration>0&&(this.toastElement.timeOutValue=window.setTimeout(function(){this.removeElement(this.toastElement)}.bind(this),this.options.duration)),this},hideToast:function(){this.toastElement.timeOutValue&&clearTimeout(this.toastElement.timeOutValue),this.removeElement(this.toastElement)},removeElement:function(s){s.className=s.className.replace(" on",""),window.setTimeout(function(){this.options.node&&this.options.node.parentNode&&this.options.node.parentNode.removeChild(this.options.node),s.parentNode&&s.parentNode.removeChild(s),this.options.callback.call(s),t.reposition()}.bind(this),400)}},t.reposition=function(){for(var s={top:15,bottom:15},o={top:15,bottom:15},m={top:15,bottom:15},i=document.getElementsByClassName("toastify"),u,g=0;g<i.length;g++){n(i[g],"toastify-top")===!0?u="toastify-top":u="toastify-bottom";var p=i[g].offsetHeight;u=u.substr(9,u.length-1);var d=15,T=window.innerWidth>0?window.innerWidth:screen.width;T<=360?(i[g].style[u]=m[u]+"px",m[u]+=p+d):n(i[g],"toastify-left")===!0?(i[g].style[u]=s[u]+"px",s[u]+=p+d):(i[g].style[u]=o[u]+"px",o[u]+=p+d)}return this};function l(s,o){return o.offset[s]?isNaN(o.offset[s])?o.offset[s]:o.offset[s]+"px":"0px"}function n(s,o){return!s||typeof o!="string"?!1:!!(s.className&&s.className.trim().split(/\s+/gi).indexOf(o)>-1)}return t.lib.init.prototype=t.lib,t})})(C);var k=C.exports;const A=U(k),w=B().detectLocale();[{locale:"af",json:{charset:"utf-8",headers:{"Last-Translator":"Transifex Bot <>, 2023","Language-Team":"Afrikaans (https://app.transifex.com/nextcloud/teams/64236/af/)","Content-Type":"text/plain; charset=UTF-8",Language:"af","Plural-Forms":"nplurals=2; plural=(n != 1);"},translations:{"":{"":{msgid:"",comments:{translator:`
Translators:
Transifex Bot <>, 2023
...
Language: zu_ZA
Plural-Forms: nplurals=2; plural=(n != 1);
`]},Undo:{msgid:"Undo",comments:{reference:"lib/toast.ts:223"},msgstr:[""]}}}}}].map(e=>w.addTranslation(e.locale,e.json));const x=w.build();x.ngettext.bind(x),x.gettext.bind(x);const b="off",D="polite",P="assertive";var F=(e=>(e[e.OFF=b]="OFF",e[e.POLITE=D]="POLITE",e[e.ASSERTIVE=P]="ASSERTIVE",e))(F||{});const M=7e3;function v(e,a){if(a=Object.assign({timeout:M,isHTML:!1,type:void 0,selector:void 0,onRemove:()=>{},onClick:void 0,close:!0},a),typeof e=="string"&&!a.isHTML){const s=document.createElement("div");s.innerHTML=e,e=s.innerText}let t=a.type??"";typeof a.onClick=="function"&&(t+=" toast-with-click ");const r=e instanceof Node;let l=F.POLITE;a.ariaLive?l=a.ariaLive:(a.type==="toast-error"||a.type==="toast-undo")&&(l=F.ASSERTIVE);const n=A({[r?"node":"text"]:e,duration:a.timeout,callback:a.onRemove,onClick:a.onClick,close:a.close,gravity:"top",selector:a.selector,position:"right",backgroundColor:"",className:"dialogs "+t,escapeMarkup:!a.isHTML,ariaLive:l});return n.showToast(),n}function J(e,a){return v(e,{...a,type:"toast-error"})}function R(e,a){return v(e,{...a,type:"toast-success"})}export{R as S,J as v};
