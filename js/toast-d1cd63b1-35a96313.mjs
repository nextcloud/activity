...
Language: zu_ZA
Plural-Forms: nplurals=2; plural=(n != 1);
`]},Undo:{msgid:"Undo",comments:{reference:"lib/toast.ts:223"},msgstr:[""]}}}}}].map(e=>U.addTranslation(e.locale,e.json));const E=U.build();E.ngettext.bind(E),E.gettext.bind(E);const Ne="off",Ae="polite",Se="assertive";var L=(e=>(e[e.OFF=Ne]="OFF",e[e.POLITE=Ae]="POLITE",e[e.ASSERTIVE=Se]="ASSERTIVE",e))(L||{});const De=7e3;function B(e,s){var t;if(s=Object.assign({timeout:De,isHTML:!1,type:void 0,selector:void 0,onRemove:()=>{},onClick:void 0,close:!0},s),typeof e=="string"&&!s.isHTML){const r=document.createElement("div");r.innerHTML=e,e=r.innerText}let o=(t=s.type)!=null?t:"";typeof s.onClick=="function"&&(o+=" toast-with-click ");const l=e instanceof Node;let n=L.POLITE;s.ariaLive?n=s.ariaLive:(s.type==="toast-error"||s.type==="toast-undo")&&(n=L.ASSERTIVE);const a=be({[l?"node":"text"]:e,duration:s.timeout,callback:s.onRemove,onClick:s.onClick,close:s.close,gravity:"top",selector:s.selector,position:"right",backgroundColor:"",className:"dialogs "+o,escapeMarkup:!s.isHTML,ariaLive:n});return a.showToast(),a}function ze(e,s){return B(e,{...s,type:"toast-error"})}function je(e,s){return B(e,{...s,type:"toast-success"})}export{je as N,_e as l,ze as v};
